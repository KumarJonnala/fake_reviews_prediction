class Config:
    ...
    file_path = "/Users/kumar/Desktop/Projects/fake_review_detection/deceptive-opinion.csv"
    ...
    Task: Classify the following hotel review as either "truthful" or "deceptive".
    ...
    You are an expert at detecting truthful and deceptive hotel reviews.
